    ...
    <section className="py-24 bg-[rgb(243,239,233)]">
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-2xl mx-auto text-center">
          ...
          <p className="max-w-lg text-xl mx-auto mt-4 leading-relaxed text-gray-600 sm:text-2xl lg:text-3xl">
            {data.description}
          </p>
        </div>
              ...
              <div key={offer.title}>
                ...
                >
                  <div className="p-10 max-w-[620px] mx-auto">
                    ...
                    <p className="my-4 text-base text-gray-600 whitespace-break-spaces text-justify">
                      {offer.description}
                    </p>
                    {offer.urls && (
        ...
        <div className="mt-20 px-4 py-8 sm:px-6 lg:px-16 bg-white rounded-lg text-center shadow-lg">
          <h2 className="mt-12 text-2xl font-bold leading-tight text-gray-900 sm:text-3xl lg:text-4xl">
            Jak zacząć?
          </h2>
          <div className="mt-16">
            <p className="leading-relaxed text-black">
              Pracujemy zdalnie lub stacjonarnie na terenie Wrocławia, Warszawy
              i okolic.
              <br />
              Do rozpoczęcia pracy nad koncepcją potrzebujemy rzutu
              domu/mieszkania oraz wysokości pomieszczeń lub przekroju.
            </p>
