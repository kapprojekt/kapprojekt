...
Jeśli posiadasz swoich Wykonawców, poinformuj nas o ustalonym terminie.
Zalecamy ustalenie harmonogramu prac projektowych przed zarezerwowaniem ternimu u Wykonawców.
...
Dla metrażu powyżej 12o m2, w zależności od skomplikowania projektu przewidujemy zniżki.`,
        buttons: [
          {
            label: "Darmowa wycena",
            url: "/cennik",
...
możemy sobie powolić na wiele mebli na wymiar - nie zawsze wszytskie
...
powyżej 4.200 zł
możemy sobie powolić na meble na wymiar tam, gdzie chcemy
...
W zależności do lokalizacji i skomplikowania projektu ceny Wykoanwców mogą się różnić, co wpływa na finalną cenę wykończenia. Przyjmujemy średnią ceną  ok 800 zł/m2
We Wrocławiu, Lublinie i okolicach, ceny wahają się od 650 zł do 850 zł/m2.
W Warszawie ceny mogą dochodzić do 1100 zł/m2.


Na początku współpracy dobrze zdecydować się. chociaż na przybliżony budżet. Takie rozwiązanie sprawia, że projekt od początku powstaje z myślą o realnym zfinalizowaniu w takiej formie, jaką zobaczysz na rysunkach i wizualizacjach.

Możesz rozłożyć zakupy na etapy i dzięki temu podnieść budżet bez rezygacji np. z wymarzonego parkietu drewnianego lub wysokiej klasy bateriach łazienkowcyh.
Takie rozwiązanie zalecamy klinetom, którzy planują wykończenie na lata, a nie mogą pozwolić sobie na wysoki standard od razu.
...
Terniny są przybliżone i zależą od terninu zgłoszenia Klineta i sprawności w podejmowaniu decyzji. Jeśli zależy Ci na czasie, napisz do nas, na pewno weźmiemy to pod uwagę przy tworzeniu harmonogramu.`,
        buttons: [
          {
      ...
      {
        text: `Sprawdź czym różnią się Projekt Funkcjonalny, Kompleksowy i Wykoanwczy.`,
        buttons: [
          {
            label: "Zobacz ofertę",
            url: "/cennik",
      ...
      {
        text: `Jeśli chcesz
skonsulować możliwości zmiany w swoich mieszkaniu - kolory, dekoracje, układ pomieszczeń
